...
// Map of theme names to their corresponding icons and colors
// Customized for the actual themes: neploy, gruvbox, rosepine, tokyonight
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className={cn(
            "w-full justify-between px-2 py-1.5 text-sm font-medium",
          ...
          <div className="flex items-center gap-2">
            <div
              className={cn(
                ...
                isDark ? currentTheme.darkColor : currentTheme.color,
              )}
            >
        ...
        <div className="mb-2 px-1">
          <div className="flex items-center rounded-md p-1">
            <Button
              ...
              className={cn("flex-1 h-8 text-xs font-medium", !isDark ? "shadow-sm" : "shadow-none")}
            >
